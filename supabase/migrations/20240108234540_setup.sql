...
AS $$
DECLARE
  project_url TEXT := 'https://vqsvirxkvgeiyccbwril.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZxc3ZpcnhrdmdlaXljY2J3cmlsIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0NTU4NDkxNSwiZXhwIjoyMDYxMTYwOTE1fQ.sp52wCTmLkEf3pITFMNtvw-mRFlpZJ4tS7GOQA3RjAI'; -- full access needed for http request to storage
